...
function openNewWindow() {
    // Open the new window
    const newWindow = window.open(`/B/${countryPrefix}/showroom.html`, '_blank');

    // Wait for the new window to load and send session data
    newWindow.onload = function () {
        ...
        // Send session data to the new window
        newWindow.postMessage(sessionData, "*");
    };
}
    ...
    <div class="navbar-collapse nav-main-collapse collapse">
        <div class="container">
            <nav class="nav-main mega-menu">
                <ul class="nav nav-pills nav-main" id="mainMenu">
                    <li>
                        <a href="#" onclick="openNewWindow(); return false;">Showroom</a>
                    </li>
                    <li>
                        <a href="/B/${countryPrefix}/virtualStore.html">Virtual Store</a>
                    </li>
